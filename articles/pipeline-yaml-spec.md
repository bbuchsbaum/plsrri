...
#> dataset:
#>   bids_dir: /tmp/RtmpZUh9Gh/plsrri-yaml-28ed4c2441db/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpZUh9Gh/plsrri-yaml-28ed4c2441db/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpZUh9Gh/plsrri-yaml-28ed4c2441db/fir-out
```

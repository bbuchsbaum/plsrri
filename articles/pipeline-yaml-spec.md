...
#> dataset:
#>   bids_dir: /tmp/RtmpGnCJp5/plsrri-yaml-281f5abb38cb/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpGnCJp5/plsrri-yaml-281f5abb38cb/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpGnCJp5/plsrri-yaml-281f5abb38cb/fir-out
```

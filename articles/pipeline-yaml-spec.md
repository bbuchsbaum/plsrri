...
#> dataset:
#>   bids_dir: /tmp/RtmpttAQ7B/plsrri-yaml-288e32b9dcdd/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpttAQ7B/plsrri-yaml-288e32b9dcdd/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpttAQ7B/plsrri-yaml-288e32b9dcdd/fir-out
```

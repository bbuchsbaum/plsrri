...
#> dataset:
#>   bids_dir: /tmp/RtmpFoeENu/plsrri-yaml-282237a1d227/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpFoeENu/plsrri-yaml-282237a1d227/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpFoeENu/plsrri-yaml-282237a1d227/fir-out
```

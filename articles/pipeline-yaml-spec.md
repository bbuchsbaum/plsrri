...
#> dataset:
#>   bids_dir: /tmp/RtmpuJanqc/plsrri-yaml-2904147f59a1/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpuJanqc/plsrri-yaml-2904147f59a1/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/RtmpuJanqc/plsrri-yaml-2904147f59a1/fir-out
```

...
#> dataset:
#>   bids_dir: /tmp/Rtmp8N3lIK/plsrri-yaml-275c22d659dc/bids
#>   task: stroop
#> design:
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/Rtmp8N3lIK/plsrri-yaml-275c22d659dc/out
```
...
#>   nboot: 0
#> outputs:
#>   root: /tmp/Rtmp8N3lIK/plsrri-yaml-275c22d659dc/fir-out
```
